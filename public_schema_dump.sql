...
CREATE OR REPLACE TRIGGER "Logo Project Stage Update Notification" AFTER UPDATE ON "public"."logo_design_projects" FOR EACH ROW EXECUTE FUNCTION "supabase_functions"."http_request"('https://brgtyzutexrumzwryisa.supabase.co/functions/v1/notify-project-stage', 'POST', '{"Content-type":"application/json"}', '{}', '5000');



CREATE OR REPLACE TRIGGER "Project Stage Update Notification" AFTER UPDATE ON "public"."projects" FOR EACH ROW EXECUTE FUNCTION "supabase_functions"."http_request"('https://brgtyzutexrumzwryisa.supabase.co/functions/v1/notify-project-stage', 'POST', '{"Content-type":"application/json"}', '{}', '5000');



CREATE OR REPLACE TRIGGER "Social Graphic Project Stage Update Notification" AFTER UPDATE ON "public"."social_graphics_projects" FOR EACH ROW EXECUTE FUNCTION "supabase_functions"."http_request"('https://brgtyzutexrumzwryisa.supabase.co/functions/v1/notify-project-stage', 'POST', '{"Content-type":"application/json"}', '{}', '5000');



CREATE OR REPLACE TRIGGER "Web Project Stage Update Notification" AFTER UPDATE ON "public"."web_design_projects" FOR EACH ROW EXECUTE FUNCTION "supabase_functions"."http_request"('https://brgtyzutexrumzwryisa.supabase.co/functions/v1/notify-project-stage', 'POST', '{"Content-type":"application/json"}', '{}', '5000');
...
CREATE OR REPLACE TRIGGER "tg_notify_new_client" AFTER INSERT ON "public"."profiles" FOR EACH ROW EXECUTE FUNCTION "public"."notify_new_client"();
