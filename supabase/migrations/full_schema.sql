...
CREATE OR REPLACE FUNCTION "public"."mark_notification_read"("_nid" "uuid") RETURNS "void"
    LANGUAGE "sql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
  update public.notifications
...
ALTER FUNCTION "public"."mark_notification_read"("_nid" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."sync_role_to_app_meta"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$ 
begin
  update auth.users
...
ALTER FUNCTION "public"."sync_role_to_app_meta"() OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."logo_design_projects" (
    ...
    "current_stage" "text" DEFAULT 'uninitialized'::"text" NOT NULL,
    ...
    CONSTRAINT "chk_logo_design_projects_current_stage" CHECK (("current_stage" = ANY (ARRAY['uninitialized'::"text", 'discovery'::"text", 'concept-development'::"text", 'refinement'::"text", 'finalization'::"text", 'delivery'::"text"]))),
...
CREATE TABLE IF NOT EXISTS "public"."social_graphics_projects" (
    ...
    "feedback_history" "jsonb",
    "approval_date" timestamp with time zone,
    CONSTRAINT "chk_social_graphics_projects_current_stage" CHECK (("current_stage" = ANY (ARRAY['uninitialized'::"text", 'discovery'::"text", 'concept-development'::"text", 'refinement'::"text", 'finalization'::"text", 'delivery'::"text"]))),
...
CREATE TABLE IF NOT EXISTS "public"."web_design_projects" (
    ...
    "approval_date" timestamp with time zone,
    "due_date" "date",
    CONSTRAINT "chk_web_design_projects_current_stage" CHECK (("current_stage" = ANY (ARRAY['uninitialized'::"text", 'discovery'::"text", 'concept-development'::"text", 'refinement'::"text", 'finalization'::"text", 'delivery'::"text"]))),
...
COMMENT ON COLUMN "public"."web_design_projects"."due_date" IS 'The date by which the project is expected to be completed.';
...
CREATE OR REPLACE TRIGGER "Logo Project Stage Update Notification" AFTER UPDATE ON "public"."logo_design_projects" FOR EACH ROW EXECUTE FUNCTION "supabase_functions"."http_request"('https://brgtyzutexrumzwryisa.supabase.co/functions/v1/notify-project-stage', 'POST', '{"Content-type":"application/json","x-webhook-secret":"notify-stage-webhook-secret-2024"}', '{}', '5000');



CREATE OR REPLACE TRIGGER "Project Stage Update Notification" AFTER UPDATE ON "public"."projects" FOR EACH ROW EXECUTE FUNCTION "supabase_functions"."http_request"('https://brgtyzutexrumzwryisa.supabase.co/functions/v1/notify-project-stage', 'POST', '{"Content-type":"application/json","x-webhook-secret":"notify-stage-webhook-secret-2024"}', '{}', '5000');



CREATE OR REPLACE TRIGGER "Social Graphic Project Stage Update Notification" AFTER UPDATE ON "public"."social_graphics_projects" FOR EACH ROW EXECUTE FUNCTION "supabase_functions"."http_request"('https://brgtyzutexrumzwryisa.supabase.co/functions/v1/notify-project-stage', 'POST', '{"Content-type":"application/json","x-webhook-secret":"notify-stage-webhook-secret-2024"}', '{}', '5000');



CREATE OR REPLACE TRIGGER "Web Project Stage Update Notification" AFTER UPDATE ON "public"."web_design_projects" FOR EACH ROW EXECUTE FUNCTION "supabase_functions"."http_request"('https://brgtyzutexrumzwryisa.supabase.co/functions/v1/notify-project-stage', 'POST', '{"Content-type":"application/json","x-webhook-secret":"notify-stage-webhook-secret-2024"}', '{}', '5000');
...
CREATE OR REPLACE TRIGGER "tg_notify_new_client_insert" AFTER INSERT ON "public"."profiles" FOR EACH ROW WHEN (("new"."role" = 'client'::"text")) EXECUTE FUNCTION "public"."notify_new_client"();



CREATE OR REPLACE TRIGGER "tg_notify_new_client_role" AFTER UPDATE OF "role" ON "public"."profiles" FOR EACH ROW WHEN ((("new"."role" = 'client'::"text") AND ("old"."role" IS DISTINCT FROM "new"."role"))) EXECUTE FUNCTION "public"."notify_new_client"();



CREATE OR REPLACE TRIGGER "trg_profile_role_insert" AFTER INSERT ON "public"."profiles" FOR EACH ROW EXECUTE FUNCTION "public"."sync_profile_role_to_auth_users"();



CREATE OR REPLACE TRIGGER "trg_profile_role_update" AFTER UPDATE OF "role" ON "public"."profiles" FOR EACH ROW WHEN (("new"."role" IS DISTINCT FROM "old"."role")) EXECUTE FUNCTION "public"."sync_profile_role_to_auth_users"();
...
CREATE POLICY "Notifications: client can read own" ON "public"."notifications" FOR SELECT USING (("auth"."uid"() = "user_id"));



CREATE POLICY "Notifications: client can update own" ON "public"."notifications" FOR UPDATE USING (("auth"."uid"() = "user_id")) WITH CHECK (("auth"."uid"() = "user_id"));
...
CREATE POLICY "bir_files_admin_read_all" ON "public"."bir_file" FOR SELECT TO "authenticated" USING (("public"."get_user_role"("auth"."uid"()) = 'admin'::"text"));



CREATE POLICY "bir_files_designer_read" ON "public"."bir_file" FOR SELECT TO "authenticated" USING ((("public"."get_user_role"("auth"."uid"()) = 'designer'::"text") AND (EXISTS ( SELECT 1
   FROM "public"."business_information_requests" "bir"
  WHERE (("bir"."id" = "bir_file"."bir_id") AND "public"."is_designer_assigned_to_project"("auth"."uid"(), "bir"."project_id", "bir"."project_type"))))));
...
CREATE POLICY "owner-or-trigger can insert" ON "public"."notifications" FOR INSERT WITH CHECK ((("auth"."uid"() = "user_id") OR ("auth"."uid"() IS NULL)));
...
GRANT ALL ON FUNCTION "public"."mark_notification_read"("_nid" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."mark_notification_read"("_nid" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."mark_notification_read"("_nid" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."sync_role_to_app_meta"() TO "anon";
GRANT ALL ON FUNCTION "public"."sync_role_to_app_meta"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."sync_role_to_app_meta"() TO "service_role";
...
GRANT INSERT("status"),UPDATE("status") ON TABLE "public"."business_information_requests" TO "authenticated";
